                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex flex-col">
                                            ...
                                            <span className="text-gray-400 text-sm">
                                                Até{' '}
                                                {new Date(goal.estimatedEndDate).toLocaleDateString(
                                                    'pt-BR',
                                                )}
                                            </span>
                                        </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-secondary/40 backdrop-blur-sm rounded-2xl shadow-xl border border-white/10 p-6">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <div
                                className={`${balance >= 0 ? 'bg-blue-500/20' : 'bg-red-500/20'} p-2 rounded-lg`}
                            >
                                <IoDocumentTextOutline
                                    color={balance >= 0 ? '#3b82f6' : '#f87171'}
                                />
                            </div>
                        </div>
                        <p
                            className={`text-3xl font-bold ${balance >= 0 ? 'text-white' : 'text-red-400'}`}
                        >
                            R$ {balance.toFixed(2)}
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewDebt({ ...newDebt, estimatedEndDate: e.target.value })
                                }
                                className="w-full bg-gray-700/50 text-white px-4 py-3 rounded-lg border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500"
                            />
                        </div>
                        ...
                        <div>
                            <label className="block text-gray-400 text-sm mb-2">
                                Valor Abatido Atualmente
                            </label>
                            <input
                                type="number"
                                value={newDebt.current ?? ''}
                                onChange={(e) =>
                                    setNewDebt({ ...newDebt, current: Number(e.target.value) })
                                }
                                className="w-full bg-gray-700/50 text-white px-4 py-3 rounded-lg border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500"
                                placeholder="500.00"
                            />
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewGoal({ ...newGoal, createdAt: e.target.value })
                                }
                                className="w-full bg-gray-700/50 text-white px-4 py-3 rounded-lg border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setNewIncome({
                                        ...newIncome,
                                        type: e.target.value as 'monthly' | 'extra',
                                    })
                                }
                                className="w-full bg-gray-700/50 text-white px-4 py-3 rounded-lg border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500"
                            >
