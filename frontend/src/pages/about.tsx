                ...
                <div className="grid gap-12 lg:grid-cols-2 items-center">
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        <div className="flex flex-col items-center sm:flex-row gap-4 justify-center lg:justify-start">
                            <a
                                href="#"
                                className="text-base bg-neutral-200 text-black p-3 rounded-xl hover:cursor-pointer text-primary-foreground hover:bg-neutral-300"
                            >
                                Comece Agora!
                            </a>
                    ...
                    <div className="relative flex justify-center lg:justify-end">
                        <div className="relative">
                            ...
                            <img
                                src={PixyLogo}
                                className="w-64 h-64 md:w-72 md:h-80 relative drop-shadow-2xl"
                            />
                            ...
                            <div className="absolute -top-4 -left-4 animate-float bg-neutral-100/80 backdrop-blur-lg text-black border border-border rounded-xl p-3 shadow-lg">
                                <div className="flex items-center gap-2">
                                    <div className="w-8 h-8 bg-primary/50 rounded-full flex items-center justify-center text-lg">
                                        🔥
                                    </div>
                            ...
                            <div className="absolute bottom-12 -right-4 animate-float-delayed bg-neutral-100/80 backdrop-blur-lg text-black border border-border rounded-xl p-3 shadow-lg">
                                <div className="flex items-center gap-2">
                                    <div className="w-8 h-8 bg-secondary/50 rounded-full flex items-center justify-center text-lg">
                                        💎
                                    </div>
                                    <div className="text-xs">
